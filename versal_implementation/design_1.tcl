...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.REGION {0} \
   CONFIG.CONNECTIONS {MC_0 { read_bw {100} write_bw {100} read_avg_burst {4} write_avg_burst {4}} M01_AXI { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}} M00_AXI { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}}  M00_AXI {read_bw {5} write_bw {5}} M01_AXI {read_bw {5} write_bw {5}}} \
  ...
  # Create instance: placer_interface_wra_0, and set properties
  set block_name placer_interface_wraper
  set block_cell_name placer_interface_wra_0
  if { [catch {set placer_interface_wra_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $placer_interface_wra_0 eq "" } {
 ...
 ] [get_bd_pins /placer_interface_wra_0/ram_rst]
...
{PULL disable} {SCHMITT 0} {SLEW slow} {USAGE Reserved}}\
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins placer_interface_wra_0/data_in]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins placer_interface_wra_0/done]
  connect_bd_net -net placer_interface_wra_0_ack [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins placer_interface_wra_0/ack]
  connect_bd_net -net placer_interface_wra_0_address [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins placer_interface_wra_0/address]
  connect_bd_net -net placer_interface_wra_0_data_out [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins placer_interface_wra_0/data_out]
  connect_bd_net -net placer_interface_wra_0_ram_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins placer_interface_wra_0/ram_en]
  connect_bd_net -net placer_interface_wra_0_ram_rst [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins placer_interface_wra_0/ram_rst]
  connect_bd_net -net placer_interface_wra_0_we [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins placer_interface_wra_0/we]
  connect_bd_net -net rst_versal_cips_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_0_smc/aresetn] [get_bd_pins placer_interface_wra_0/rst] [get_bd_pins rst_versal_cips_0_99M/peripheral_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_0_smc/aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins placer_interface_wra_0/clk] [get_bd_pins rst_versal_cips_0_99M/slowest_sync_clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
  connect_bd_net -net versal_cips_0_pl0_resetn [get_bd_pins rst_versal_cips_0_99M/ext_reset_in] [get_bd_pins versal_cips_0/pl0_resetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_bram_ctrl_0_bram/regcea] [get_bd_pins axi_bram_ctrl_0_bram/regceb] [get_bd_pins xlconstant_0/dout]
